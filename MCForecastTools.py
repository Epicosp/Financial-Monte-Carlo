...
class MCSimulation:
    ...
    def plot_simulation(self):
        ...
        return self.simulated_return.plot(
            legend=None, title=plot_title, figsize=(20, 10)
        )
...
def progress_bar(current, total, bar_length=20):
    """
    progress bar for progression of computation

    function courtesy of Aravind Voggu, seen at
